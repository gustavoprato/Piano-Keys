...
// notes contains de document elements by key.
const notes = [];
...
/// This function will be used later on to assign events to the keys, so it should take one parameter-you can call it note (placeholder for the key elements).
